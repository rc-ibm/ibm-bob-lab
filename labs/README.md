# AltoroJ - IBM Bob Workshop Edition

## IBM Bob Workshop Labs
...
**Key Topics:**
- Servlet-based web architecture analysis
...
- Vulnerability discovery (SQL injection, XSS, command injection, etc.)
- OWASP Top 10 and CWE classification
- Bob Findings panel for tracking issues
...
**Key Topics:**
- Terraform configuration generation for IBM Cloud
- MCP (Model Context Protocol) server integration
- IBM Code Engine deployment and configuration
- Auto-scaling and resource management
- Private container registry authentication
- Infrastructure troubleshooting and management
